...
export function TrafficGrowth3D() {
    ...
    return (
        <div className="relative w-full flex flex-col items-center justify-center gap-4 select-none">
            <div
            ...
            <div
                className="grid gap-1.5 p-3 rounded-2xl border border-emerald-500/15 bg-white/[0.02] w-full max-w-[340px]"
            ...
            >
                {Array.from({ length: GRID_ROWS * GRID_COLS }).map((_, i) => {
                    ...
                    const barPct = DATA[col].visitors / MAX;
