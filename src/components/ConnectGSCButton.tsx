/**
 * Canonical Google Search Console connect button.
 * Features a shimmer-on-hover animation and robust loading state.
 */
"use client";
...
export function ConnectGSCButton({
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-black/5 to-transparent -translate-x-[150%] group-hover:translate-x-[150%] transition-transform duration-700 ease-in-out" />
            <svg className="relative z-10" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
